...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The user is preparing parts by assembling grommets onto standoffs, which is a preparatory step before the main assembly begins. This action does not directly correspond to any of the numbered steps in the manual, which start with mounting the FC isolator.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the person organizing and preparing parts, specifically the standoffs and grommets, which are components for later steps but not part of the initial assembly described in Step 1. Step 1 involves mounting the FC isolator to the rear plate using specific screws, which is not what is happening in the video segment.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the person handling small purple components (likely the X-LOCK FC isolators or similar standoffs) and a screwdriver, but not actively assembling them into the main frame. The action of 'testing the fit or slightly turning a screw within a small purple cylindrical standoff' and 'repositioning one of the larger purple 'bear face' standoffs' suggests preparation or inspection rather than a specific assembly step from the manual. The first assembly step (Step 1) involves mounting the X-LOCK FC isolator to the rear plate, which is not clearly happening in the video segment.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the person picking up a hex driver and testing it with a standoff, but no actual assembly is taking place. This appears to be a preparation step before starting the assembly, likely checking tool compatibility or part fit. The parts being handled (purple 'bear face' standoffs) are mentioned in Step 1 as 'X-LOCK FC ISOLATOR', but no screws are being inserted yet.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler connecting a purple 'bear face' standoff to a purple cylindrical standoff using an M3 x 16mm socket head screw. This action is not explicitly described as a numbered step in the provided manual, but rather appears to be a sub-assembly or preparation for a later step, likely Step 1 which mentions the X-LOCK FC isolator and M3x22mm and M3x6mm screws. The parts being assembled in the video (standoffs) are components of the FC isolator mentioned in Step 1, but the specific assembly shown is not a direct match for any numbered step.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video segment shows the person examining and pointing to parts, but no actual assembly or fastening is taking place. This indicates a preparation phase before starting Step 1 of the assembly process.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler picking up the split rear plate and the X-LOCK FC isolator, which directly corresponds to the first part of Step 1 in the manual: 'START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR'.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler attaching the X-LOCK FC isolator (small pink component) to the split rear plate using M3x22mm screws, which directly corresponds to the first part of Step 1 in the manual. The text description also confirms the use of M3 x 22mm pan head screws for this attachment.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler disassembling a previously started assembly and returning components to their original positions, which indicates preparation rather than performing any specific assembly step from the manual. The text description also confirms this is a 'resetting' action.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler attaching the X-LOCK FC Isolator to the split rear plate, which is the first action described in Step 1 of the manual. The text description also mentions the assembler attaching a small pink component to one of the intricately designed black main body plates, which aligns with the visual of the X-LOCK FC Isolator being attached to the split rear plate.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS | Next: **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the user attaching a pink component (X-LOCK FC Isolator) to the main body plate using an M3x6mm screw, which directly corresponds to the first part of Step 1 in the manual: 'MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS'. The M3x22mm screws are not yet used, but the M3x6mm screw is being used for the isolator.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS | Next: **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the person removing an M3x6mm screw and then installing an M3x16mm screw to secure a pink component to the main body plate. This action aligns with Step 1 of the manual, which instructs to mount the X-LOCK FC ISOLATOR (the pink component) with M3x22mm and M3x6mm screws. The subsequent re-attachment of the smaller pink component also fits within the initial assembly phase described in Step 1, before moving to securing arms in Step 2.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS | Next: **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the assembler tightening a screw to attach the pink FC isolator to the rear plate, which directly corresponds to Step 1 of the manual. The text description also mentions 'finishes tightening a pre-existing screw to fully secure the smaller pink component onto the main body plate', which aligns with the final action of Step 1.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the person tightening M3x16mm screws to secure the arm wedges, which directly corresponds to Step 2 of the manual. The text description also mentions tightening M3x16mm socket head screws to secure a long side plate, which is part of the arm assembly.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler using an M3 x 6mm pan head screw to attach a pink component (X-LOCK FC ISOLATOR) to the main body plate (split rear plate). This directly corresponds to Step 1 of the manual, which instructs to mount the X-LOCK FC ISOLATOR with M3x22mm and M3x6mm screws to the split rear plate.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS | Next: **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the person tightening a screw on a pink component to secure it to the main body plate, which aligns with Step 1 of the manual that describes mounting the X-LOCK FC ISOLATOR (pink component) to the split rear plate using M3x22mm and M3x6mm screws. The component being attached and the action of securing it match this step.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the person picking up small black fasteners/spacers and then a black arm, which are parts for the assembly. This looks like a preparation phase before starting the actual assembly steps outlined in the manual. The manual's first step involves mounting the X-LOCK FC isolator, which is not what's happening in the video clip.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the person attaching the arms to the main frame using screws, which directly corresponds to Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The keyframes also show the arms being attached to the main plate.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the person removing a screw from a partially assembled frame, which is not part of the assembly steps but rather a disassembly or adjustment. The frame is already in a state that resembles the end of step 2 or beginning of step 3, but the action itself is not an assembly step.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the user attaching the last arm to the main frame using a screw, which aligns with Step 2: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The video description also mentions 'attaching the final black arm to the silver main frame bottom plate' and 'inserts the last M3 x 6mm pan head screw into the arm and main plate, and subsequently tightens it using a 2.0mm screwdriver to secure the arm.' Although the screw size mentioned in the video description (M3 x 6mm) differs from the manual (M3 x 16mm), the action of securing the arm is consistent with Step 2. The assembly state in the keyframes shows all arms being attached to the bottom plate, which is the outcome of Step 2 before moving to attach the front plate in Step 3.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the assembler attaching the arms to the main frame using M3x16mm socket head screws, which directly corresponds to Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The text description also mentions securing an M3x16mm socket head screw into the main frame.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the assembler tightening M3x16mm screws to secure the arms and LED components to the bottom plate, which directly corresponds to Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.')
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS | Next: **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the assembler placing the rear split plate onto the arms, which is the initial action described in Step 1 of the manual. The text description in the video analysis refers to 'black main frame top plate' and 'silver main frame bottom plate', but the visual evidence clearly shows the rear split plate being placed on the arms, which aligns with the beginning of Step 1. The pink LED components mentioned in the video description are likely the X-LOCK FC Isolators from Step 1. The subsequent action of securing it with screws would complete Step 1.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the user attaching the long side plates (referred to as 'arm wedges' in the manual) to the main frame using M3x6mm screws and a wrench, which directly corresponds to Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' Although the video mentions M3x6mm screws and the manual mentions M3x16mm screws, the action of attaching the arm wedges is clearly depicted in Step 2's diagram and description. The visual of the 'arm wedges' in the video matches the diagram for Step 2. The next logical step would be to add the front plate, as described in Step 3.)
...
**Instruction:** You are on **Step 4**: USE THE M3x6mm BUTTON HEAD SCREW TO SECURE THE STANDOFFS AND THE FPV CAMERA MOUNTS TO THE SPLIT PLATES. USE THE M3x16mm THROUGH THE ARMS INTO THE STANDOFFS. | Next: **Step 5**: ATTACH THE TOP PLATE TO THE ASSEMBLY BY USING THE M3X6MM BUTTON HEAD SCREWS IN THE FRONT AND THE M3X6MM COUNTERSINK HEAD SCREWS IN THE BACK. (high: The video shows the assembler tightening screws to attach the side plates and standoffs, which aligns with Step 4's instruction to 'secure the standoffs and the FPV camera mounts to the split plates' using M3x6mm and M3x16mm screws. The frame in the video also matches the state of assembly depicted in Step 4, with the arms and split plates already attached, and the standoffs being secured.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the assembler attaching the arms to the main frame and securing them with screws, which directly corresponds to Step 2 of the manual, 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The text description also mentions tightening screws already present on the frame, which aligns with securing the arms.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the assembler tightening an M3x16mm screw to secure a side plate (arm wedge) to the main frame, which directly corresponds to Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.')
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the assembler tightening screws to secure the arms, which aligns with Step 2 of the manual. The subsequent disassembly and reassembly of the main frame with purple screws is a preparation for the next steps, but the primary action shown is securing the arms.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler disassembling a pre-assembled frame and then test-fitting parts. This is not part of the assembly steps 1-6, but rather a preparation or inspection phase before starting the actual assembly process outlined in the manual.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the person tightening M3x16mm screws to secure the arms to the bottom plate, which directly corresponds to Step 2 of the manual. The text description also mentions tightening M3 x 16mm pan head screws into the center holes of the black frame's bottom plate.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the person examining the drone frame parts and tools, and then removing them from the workspace. This is a preparatory phase before starting the actual assembly steps outlined in the manual.)
