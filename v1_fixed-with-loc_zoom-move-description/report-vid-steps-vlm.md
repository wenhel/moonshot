...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the user preparing small components like standoffs and grommets, and picking up a screw. This is a preparatory phase before actual assembly, which aligns with step 1 of the manual where the FC isolator is mounted using specific screws and the rear plate.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the person organizing and preparing small components like standoffs, grommets, and screws, which aligns with a preparation phase before starting the actual assembly steps outlined in the manual. Specifically, the video shows the person picking up a cylindrical standoff and a grommet, and then picking up screws, which are all components that will be used in Step 1, but the actual assembly of these components onto the rear plate (as described in Step 1) has not yet begun.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the person handling small purple cylindrical standoffs and 'bear face' standoffs, and a blue 2.0mm hex driver. The text description mentions testing the fit or slightly turning a screw within a small purple cylindrical standoff. These actions appear to be preparatory, possibly checking parts or tools, rather than actively assembling according to a specific step. Step 1 involves mounting the X-LOCK FC isolator with M3x22mm and M3x6mm screws, which is not what is being done in the video. The parts being handled (small purple cylindrical standoffs and 'bear face' standoffs) are components of the X-LOCK FC isolator mentioned in Step 1, but the actual mounting process hasn't started yet.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the person picking up a hex driver and testing it with a 'bear face' standoff, which is a component of the X-LOCK FC isolator mentioned in Step 1. However, no actual assembly is taking place; it appears to be a preparation or inspection of parts and tools before starting the assembly process. The 'bear face' standoffs are part of the FC isolator, which is the first component to be mounted in Step 1.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video segment shows the assembler preparing parts by screwing a small cylindrical standoff into a 'bear face' standoff. This action is not explicitly described as a numbered step in the provided manual, but rather a sub-assembly or preparation for a later step. The manual's Step 1 involves mounting the FC isolator to the rear plate, which is a different assembly. The parts being handled (purple 'bear face' standoff, cylindrical standoff, M3x16mm screw) are components that would likely be used in later steps (e.g., the FC isolator mentioned in Step 1 or standoffs in Step 4), but the specific action of connecting these two standoffs together is a preparatory step before the main assembly begins.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video segment shows the person examining and pointing to parts, specifically a black frame plate, but no actual assembly or fastening is taking place. This indicates a preparation phase before starting Step 1 of the assembly process.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler picking up the split rear plate and the X-LOCK FC isolator, and then placing the isolator onto the plate. This directly corresponds to the beginning of Step 1 in the manual, which instructs to 'START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR'.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler attaching a small pink component (X-LOCK FC Isolator) to the main body plate using M3x22mm screws, which directly corresponds to Step 1 of the manual. The text description also confirms the use of M3 x 22mm pan head screws for this attachment.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video segment shows the assembler disassembling a previously started unit and returning parts to their original positions, which indicates preparation rather than performing a specific assembly step from the manual. The parts being handled (black main body plate, pink components, M3x22mm screws) are consistent with components used in Step 1, but the action is disassembly and reset, not assembly.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler attaching a small pink component to a main body plate, which appears to be a preparation step for the X-LOCK FC isolator mentioned in Step 1. The assembler is also checking the screws on the whiteboard, indicating preparation rather than active assembly according to the manual's steps. The text description also mentions 'preparation'.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the user assembling the X-LOCK FC isolator to the rear plate using screws, which directly corresponds to the description of Step 1 in the manual: 'START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS'.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the assembler tightening a screw to secure a pink component (arm wedge) to the main body plate, which aligns with Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The text context also mentions securing the smaller pink component onto the main body plate.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the person tightening M3x16mm screws to secure a black long side plate to the main body, which aligns with Step 2 of the manual, which describes locking the arms by tightening arm wedges using M3x16mm screws.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS | Next: **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the assembler securing a pink component (X-LOCK FC ISOLATOR) to the main body plate using an M3 x 6mm pan head screw and a 2.0mm screwdriver. This directly corresponds to Step 1 of the manual, which instructs to mount the X-LOCK FC ISOLATOR with M3x22mm and M3x6mm screws. The previous action in the video was securing the other pink component, and this action completes the attachment of the isolators as described in Step 1.)
...
**Instruction:** You are on **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS | Next: **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the person securing a pink component (X-LOCK FC ISOLATOR) to the main body plate using a screwdriver, which directly corresponds to Step 1 of the manual. The text context also confirms the action of securing a pink component to the main body plate.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the assembler placing an arm onto the main body plate and then picking up small black fasteners/spacers, which are likely the arm wedges mentioned in Step 2. The assembly state with the main body and arms being attached aligns with Step 2, which describes locking the arms using arm wedges and M3x16mm screws.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the person attaching the arms to the main frame using screws, which directly corresponds to Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The parts visible and actions taken align perfectly with this step.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the user removing a screw from a partially assembled frame, which is not part of any assembly step in the provided manual. The manual steps describe adding components, not removing them. This action appears to be preparation or disassembly rather than following the assembly instructions.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the user attaching the last arm to the main frame bottom plate using an M3 x 6mm pan head screw, which aligns with Step 2 of the manual, 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The text context also mentions inserting an M3 x 6mm pan head screw into the arm and main plate.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the assembler attaching the arms to the main frame using M3x16mm screws, which directly corresponds to Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The text context also mentions securing an M3x16mm socket head screw into the main frame and attaching side plates, which are part of the arm assembly process.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the assembler tightening M3x16mm screws to secure the arms, which directly corresponds to Step 2 of the manual. The parts visible (bottom plate, arms, pink LED components) and the action of tightening screws match the description of locking the arms in place.)
...
**Instruction:** You are on **Step 5**: ATTACH THE TOP PLATE TO THE ASSEMBLY BY USING THE M3X6MM BUTTON HEAD SCREWS IN THE FRONT AND THE M3X6MM COUNTERSINK HEAD SCREWS IN THE BACK. (high: The video shows the assembler placing the top plate onto the assembly, which directly corresponds to Step 5 in the manual: 'ATTACH THE TOP PLATE TO THE ASSEMBLY'.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the user tightening a screw to secure the arms to the main frame, which aligns with Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The text context also mentions inserting a screw through a side plate into the main frame and tightening it, which is consistent with securing the arms.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the assembler tightening screws to secure the arms to the main frame, which directly corresponds to Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The previous step (Step 1) involved mounting the FC isolator and the current action is securing the arms, indicating the transition to the next stage of assembly.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the assembler attaching the arms to the main frame and tightening them with screws, which directly corresponds to Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The screws being used are M3x16mm pan head screws, as indicated by the whiteboard and the action of inserting them into the frame.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the assembler tightening an M3x16mm screw to secure an arm to the main frame, which directly corresponds to Step 2 of the manual: 'Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place.' The visual of the assembled arms and the specific screw size match this step.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the person disassembling the frame and then reassembling the main frame top plate to the bottom plate with purple screws, which are not mentioned in the provided steps. The initial action of tightening a screw seems to be a final touch from a previous assembly, and the subsequent actions are preparatory for a new assembly or re-assembly, not directly following any of the numbered steps as described. The purple screws are not mentioned in any of the steps, suggesting a preparation phase before starting step 1 or a different assembly process.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 1**: START THE ASSEMBLY BY USING THE SPUT REAR PLATE TO MOUNT THE X-LOCK FC ISOLATOR WITH THE M3x22MM AND THE M3x6MM SCREWS (high: The video shows the assembler disassembling a pre-assembled drone frame, specifically removing the top plate and then test-fitting side plates. This is a preparatory step before starting the assembly process as described in the manual, which begins with mounting the FC isolator to the rear plate.)
...
**Instruction:** You are on **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. | Next: **Step 3**: ADD THE SPLIT FRONT PLATE TO THE ASSEMBLY AND USE THE M3X6MM IN THE MIDDLE TO SECURE IT (high: The video shows the person tightening M3x16mm screws into the center of the bottom plate, which corresponds to Step 2 of the manual, where the arms are locked in place using M3x16mm screws.)
...
**Instruction:** You are in preparation phase. Next you should do **Step 2**: Lock the arms by tightening the arm wedges using M3x16mm screws to lock them in place. (high: The video shows the person examining the main frame bottom plate and then picking up a frame arm and a screwdriver, which indicates preparation for assembly rather than performing a specific step from the manual. The manual's Step 1 involves mounting the FC isolator to the rear plate, which is not what is happening in the video. The video seems to be preparing for attaching the arms, which is part of Step 2.)
